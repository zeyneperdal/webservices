(: Return titles of all books published before 2002 (inclusive).:)
xquery version "1.0";
for $books in doc("https://zeyneperdal.github.io/webservices/books.xml")/BOOKS/BOOK
let $titles := $books/TITLE
where $books/@YEAR<=2002
return $titles(: Stylus Studio meta-information - (c) 2004-2009. Progress Software Corporation. All rights reserved.

<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" useresolver="yes" url="" outputurl="" processortype="saxon" tcpport="4259956" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
