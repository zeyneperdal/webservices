(: unit = 1 olanların currencynameini yazdırıp sıralaması :)

xquery version "1.0";
  
  for $cur in doc("http://tcmb.gov.tr/kurlar/today.xml")/Tarih_Date/Currency
where contains($cur/Unit,"1")
order by $cur/CurrencyName
return $cur/CurrencyName(: Stylus Studio meta-information - (c) 2004-2009. Progress Software Corporation. All rights reserved.
